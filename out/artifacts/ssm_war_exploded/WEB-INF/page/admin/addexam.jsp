                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" name="chapter" id="chapter" data-live-search="true">
                                <option value="1">程序设计ABC</option>
                                <option value="2">数据类型、运算符与表达式</option>
                                <option value="3">键盘输入与屏幕输出</option>
                                <option value="4">程序的控制结构</option>
                                <option value="5">函数</option>
                                <option value="6">数组</option>
                                <option value="7">指针</option>
                                <option value="8">结构体与共用体</option>
                                <option value="9">文件操作</option>
                                <option value="10">C程序设计常见错误与解决方案</option>
                                <option value="12">pointname</option>
                                <option value="13">我爱臭俊杰</option>
                            </select>
                            <select class="form-control" name="chaptertwo" id="chaptertwo" data-live-search="true">
<%--                                <option value="计算机与人">计算机与人</option>
                                <option value="计算机与程序设计语言">计算机与程序设计语言</option>
                                <option value="程序设计语言的故事">程序设计语言的故事</option>
                                <option value="C语言的故事">C语言的故事</option>
                                <option value="程序设计语言的工作原理">程序设计语言的工作原理</option>--%>
                                <option value="俊杰真美">俊杰真美</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
